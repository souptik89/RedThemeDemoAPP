(function (global, factory) {
	...
	(factory((global['ionic-swing'] = {}),global.ng.core,global.ng.common));
...
function prefix(key) {
    ...
    if (style[capitalizedKey] !== undefined)
...
function dashedPrefix(key) {
    var prefixedKey = get(key), upper = /([A-Z])/g;
...
var elementChildren = function (element) {
    return underscore.filter(element.childNodes, function (elem) {
...
var Stack = function (config) {
    ...
    stack.getCard = function (element) {
        var /** @type {?} */ group = underscore.find(index, function (i) {
...
var SwingStackComponent = (function () {
    function SwingStackComponent() {
        this.throwout = new core.EventEmitter();
        this.throwoutend = new core.EventEmitter();
        this.throwoutleft = new core.EventEmitter();
        this.throwoutright = new core.EventEmitter();
        this.throwoutup = new core.EventEmitter();
        this.throwoutdown = new core.EventEmitter();
        this.throwin = new core.EventEmitter();
        this.throwinend = new core.EventEmitter();
...
exports.IonicSwingModule = IonicSwingModule;
...
//# sourceMappingURL=ionic-swing.umd.js.map
